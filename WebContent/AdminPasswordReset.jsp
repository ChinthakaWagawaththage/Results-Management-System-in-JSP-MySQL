...
<div class="container">
  ...
  <form action="DaoAdminPasswordReset.jsp" method="post">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" name="pwd" placeholder="Please Enter a New Password">
    </div>
    <button type="submit" class="btn btn-danger submit">Modify</button>
