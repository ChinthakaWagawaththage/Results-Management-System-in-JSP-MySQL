...
<html>
		...
		<div class="contain pull-left">
			<form action="DaoSearch.jsp" class="form-inline ">
				...
				<div class="form-group search">
					<input type="text" name="check" class="form-control" placeholder="Please enter the  Name or Student ID" />
	...
	if(search.matches("[0-9]+")){
		sqlQuery = "SELECT * FROM dbsms.studentinfo where id='"+search+"'";
	}else{
		sqlQuery = "SELECT * FROM dbsms.studentinfo where name='"+search+"'";
	}
	
	try{
		Class.forName("com.mysql.cj.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/dbsms","root","123456");
